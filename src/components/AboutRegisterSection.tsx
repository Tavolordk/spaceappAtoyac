        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2 md:pl-8 w-full" id="register">
            ...
            <form className="space-y-4">
              <input type="text" placeholder="Nombre Completo" className="w-full p-2 rounded-md border border-[#7F4F24]" />
              <input type="email" placeholder="Correo Electrónico" className="w-full p-2 rounded-md border border-[#7F4F24]" />
              <select className="w-full p-2 rounded-md border border-[#7F4F24]">
                <option value="">Selecciona tu rol</option>
                <option value="developer">Profesionista</option>
                <option value="designer">Estudiante</option>
